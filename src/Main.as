		...
		public function controlHandler(e:Event):void {
			...
			case "1":
					...
					if (e.target.dataObj["role"] == "manager") 
					{
						...
						loader.load(new URLRequest( "http://192.168.1.168:8010/getProjectDelayInfo?un="+this.un));
					} else {
						loader = new URLLoader();
						loader.addEventListener(Event.COMPLETE, managerDataHandler);  
						loader.load(new URLRequest( "http://192.168.1.168:8010/getProjectDelayInfo?un="+this.un));
			...
			case "3":
					...
					var urlRequest:URLRequest = new URLRequest( "http://192.168.1.168:8010/getProjectInfo"); //接收数据。
