package com.readdream.as3.robot 
{
	...
	public class Robot_PicLoader extends Sprite 
	{
		...
		*/
		public function Robot_PicLoader(pUrl:String, xPos:Number = 0 , yPos:Number = 0 , picWidth:Number = NaN , picHeight:Number = NaN, sec:int = 0 ) 
		{
			this.sec = sec;
			if (pUrl != null) 
			{
		...
		{
			TweenLite.from(event.target.content, 0.1, { alpha:0 } );
		}	
	}
